...
public class DocumentLastModifiedHandler : IHandler<Document>
{
    ...
    public void Handle(Document document)
    {
        ...
        {
            //validation doesn't check out
            throw new ValidationException(new ValidationResult("Document must be modified in the last 30 days", new List<string>() { "Title" }), null, null);
        }
...
public class DocumentApprovedByLitigationHandler : IHandler<Document>
{
    ...
    public void Handle(Document document)
    {
        ...
        {
            //validation doesn't check out
            throw new ValidationException(new ValidationResult("Document must be approved by litigation", new List<string>() { "Title" }), null, null);
        }
...
public class DocumentApprovedByManagementHandler : IHandler<Document>
{
    ...
    public void Handle(Document document)
    {
        ...
        {
            //validation doesn't check out
            throw new ValidationException(new ValidationResult("Document must be approved by management", new List<string>() { "Title" }), null, null);
        }
