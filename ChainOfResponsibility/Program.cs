...
var validDocument = new Document("Hot to Avoid Java Development", DateTimeOffset.UtcNow, true, true);
var invalidDocument = new Document("Hot to Avoid Java Development", DateTimeOffset.UtcNow, false, true);
